...
<div class="overlay" id="overlay">
  <div class="modal">
    ...
    <div id="lockScreen">
      ...
      <div class="password-hint" style="margin-bottom:6px;opacity:0.8">kon ?</div>
      <div id="pwdError" style="color:#ff3b6b;font-size:13px;height:18px;margin-bottom:4px;"></div>
...
<script>
// Wrap logic to run after DOM is ready to avoid any reference errors
document.addEventListener('DOMContentLoaded', ()=>{
  // Pages content (7 pages)
  const pages = [
...
let i = 0;
  ...
  // Attach events
  openBtn.addEventListener('click', openLock);
  ...
  function unlock(){
    if(document.getElementById('pwd').value==='0000'){
      document.getElementById('pwdError').innerText='';
      ...
      // wrong password animation + message above the input
      let box = document.querySelector('#lockScreen');
      box.classList.remove('shake');
      void box.offsetWidth;
      box.classList.add('shake');
      document.getElementById('pwdError').innerText = 'Password wrong — “kon ho?”';
      // optionally vibrate (if supported)
  ...
  function render(){
    ...
    if(i === 1){
      ...
      page.style.lineHeight = '1.45'; // space thoda kam
    } else if(i === 3){
      page.style.fontSize = '13px';
      page.style.lineHeight = '1.55';
    } else if(i === 4){
